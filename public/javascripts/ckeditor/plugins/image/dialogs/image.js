    ...
    var a = function(b, c) {
        ...
        return{title:b.lang.image[c == 'image' ? 'title' : 'titleButton'],minWidth:420,minHeight:360,onShow:function() {
            ...
            {id:'Upload',hidden:true,filebrowser:'uploadButton',label:b.lang.image.upload,elements:[
                ...
                {type:'fileButton',id:'uploadButton',filebrowser:{target:'info:txtUrl',action:'QuickUpload',params:b.config.filebrowserParams()},label:b.lang.image.btnUpload,'for':['Upload','upload']}
            ]},
